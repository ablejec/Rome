This directory holds the 6 components of the SVMult tool package
useful for authors:
...
an easy implementation of the "SVMult" package (2 pages)

(4) the pdf file "authinst.pdf" with style and
coding instructions specific to -- Contributed Volumes --
